...
# score sutununun ortalamasini iki ondaliga yuvarlayarak yazdir.


# Medyanini yazdir.


# Standart sapmasini iki ondaliga yuvarlayarak yazdir.


# Ortalama medyandan kucuk mu? True/False yazdir.
