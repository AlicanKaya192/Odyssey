...
Early development (`0.1.2`). The application works end to end, but the content is still at the beginning.
...
**Not there yet:** the full curriculum (two sections of the Python Fundamentals module exist today; the target is 23 modules), badges, a place for your own notes, the in-app update system.
